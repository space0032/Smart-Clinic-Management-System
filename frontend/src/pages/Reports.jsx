        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500">Comprehensive clinic performance insights</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        {analytics.monthlyRevenue?.map((month, i) => {
                            ...
                            return (
                                <div key={i} className="flex-1 flex flex-col items-center gap-2">
                                    ...
                                    <span className="text-xs font-medium text-slate-700">${Number(month.revenue).toLocaleString()}</span>
                                </div>
                            );
                        })}
                    </div>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-lg font-bold text-slate-800">Top Doctors</h3>
                    </div>
                    <div className="space-y-3">
                        {Object.entries(analytics.appointmentsByDoctor || {})
                            ...
                            .slice(0, 5)
                            .map(([doctor, count], i) => (
                                <div key={doctor} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                    ...
                                    <span className="text-sm text-slate-500">{count} appointments</span>
                                </div>
                            ))}
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h3 className="text-lg font-bold text-slate-800">Busiest Days</h3>
                    </div>
