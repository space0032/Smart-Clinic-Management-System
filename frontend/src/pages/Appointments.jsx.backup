        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    <div className="text-gray-500 text-center py-8 bg-white rounded-xl border border-gray-100">
                        <CalendarIcon className="w-12 h-12 mx-auto text-gray-200 mb-3" />
                        <p>No appointments scheduled.</p>
                    </div>
                ) : (
                    appointments.map((appt) => (
                        <div key={appt.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    {appt.notes && <p className="text-sm text-gray-400 mt-1 italic">"{appt.notes}"</p>}
                                </div>
                            </div>
