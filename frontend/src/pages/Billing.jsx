        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500">Manage payments and revenue</p>
                </div>
                <button
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">${bills.filter(b => b.status === 'PAID').reduce((sum, b) => sum + b.amount, 0).toFixed(2)}</p>
                        </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900">${bills.filter(b => b.status === 'PENDING' || b.status === 'OVERDUE').reduce((sum, b) => sum + b.amount, 0).toFixed(2)}</p>
                        </div>
            ...
            {/* Invoice Form */}
            {showForm && (
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 w-full md:w-1/2 mx-auto">
