        ...
        <div className="space-y-6">
            ...
            {showForm && (
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                    <h2 className="text-lg font-semibold mb-4">New Patient Registration</h2>
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <textarea
                            ...
                            className="p-2 border rounded-lg md:col-span-2 h-24"
                    ...
                    <table className="w-full text-left">
                        <thead className="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase">Gender</th>
                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase">DOB</th>
                                <th className="px-6 py-3 text-xs font-semibold text-gray-500 uppercase">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200">
                            {loading ? (
                                <tr><td colSpan="5" className="px-6 py-4 text-center text-gray-500">Loading patients...</td></tr>
                                ...
                                filteredPatients.map((patient) => (
                                    <tr key={patient.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 text-gray-600">{patient.contactNo}<br /><span className="text-xs text-gray-400">{patient.email}</span></td>
